...
- [x] Все данные должны находится в `public/data/`, `src/data/` удалена
- [x] Все статические файлы в `public/`
- [x] Все страницы преобразованы в классы
- [x] Все страницы наследуются от `BasePage`
- [x] Все утилиты переименованы в PascalCase
- [x] Все сервисы переименованы в PascalCase
- [x] Все страницы переименованы в PascalCase
- [x] Все файлы-обертки удалены (NotFoundPageEntry.js - точка входа для 404, не обертка)
- [x] Все менеджеры созданы и используются
- [x] Все дублированные функции удалены (вынесены в менеджеры)
- [x] Все debug функции удалены (остались только console.error/warn для обработки ошибок)
- [x] Все импорты обновлены
- [x] `vite.config.js` обновлен
- [x] Все HTML файлы обновлены (удалены дублирующие скрипты из cv.html, research.html, community.html)
- [x] `main.js` обновлен
- [x] Код стандартизирован
