...
// Менеджер анимаций CV
const cvAnimationManager = new CVAnimationManager();
...
async function initCVPage() {
  ...
  cvAnimationManager.hideAllCVElementsImmediately();
  ...
  waitForPageReady().then(() => {
    cvAnimationManager.initializeAnimations();
  });
}
