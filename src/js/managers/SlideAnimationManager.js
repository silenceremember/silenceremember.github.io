...
export class SlideAnimationManager {
   ...
   */
  animateFirstSlide() {
    const firstSlide = this.slidesContainer.querySelector('.slide[data-slide="0"]');
  ...
  setupSlideAnimations() {
      ...
      mutations.forEach((mutation) => {
        if (mutation.type === 'attributes' && mutation.attributeName === 'class') {
          ...
          if (slide.classList.contains('active') && slide.classList.contains('slide')) {
            ...
            if (this.lastActiveSlideIndex === slideIndex && this.lastActiveSlideIndex !== null) {
              return;
            }
      ...
      mutations.forEach((mutation) => {
        if (mutation.type === 'attributes' && mutation.attributeName === 'class') {
          ...
          if (target === this.slidesContainer) {
            const currentMode = this.slidesContainer.classList.contains('tablet-scroll-mode');
            ...
            if (modeChanged && currentMode === false && this.lastKnownMode === true) {
    ...
    this.lastKnownMode = this.slidesContainer.classList.contains('tablet-scroll-mode');
  }
